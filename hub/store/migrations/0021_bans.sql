...
CREATE TABLE IF NOT EXISTS bans (
    ...
    expires_at        TEXT,                          -- NULL for a ban that does not end on its own
    lifted_at         TEXT,
    lifted_token_id   TEXT NOT NULL DEFAULT '',
    lifted_token_name TEXT NOT NULL DEFAULT '',
    listed_revision   INTEGER NOT NULL,
    delisted_revision INTEGER
);
...
ALTER TABLE servers ADD COLUMN bans_applied_revision INTEGER;
